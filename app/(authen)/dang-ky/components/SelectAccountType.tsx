    ...
    <div className="">
      ...
      <div className="flex gap-x-9 justify-center items-center">
        <div
          ...
          className={cn(
            "relative w-[300px] p-6 cursor-pointer bg-white text-input-title rounded-[.5rem] border-2 border-solid border-box hover:border-box-active transition-all",
            accountType === AccountType.client ? "border-box-active" : ""
          )}
        >
        ...
        <div
          ...
          className={cn(
            "relative w-[300px] p-6 cursor-pointer bg-white text-input-title rounded-[.5rem] border-2 border-solid border-box hover:border-box-active transition-all",
            accountType === AccountType.freelancer ? "border-box-active" : ""
          )}
        >
          <div className="absolute top-3 right-3 gap-0 flex items-center justify-center cursor-pointer">
            <div
