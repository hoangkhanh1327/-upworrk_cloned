            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    onClick={() => onOpenModal?.("edit-common-info")}
          ...
          <CardTitle className="flex items-start justify-between">
            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    onClick={() => onOpenModal?.("edit-personal-info")}
                    className="bg-transparent hover:bg-transparent border-2 border-solid border-primary-color rounded-full px-1.5"
                  >
                    <Pencil fill="#108a00" />
                  </Button>
          ...
          <div className="flex gap-x-8">
            ...
            <div className="flex-1">
              ...
              <div className="mb-1">
                ...
                <p className="text-base font-semibold">{user?.phone_num}</p>
              </div>
              <div className="mb-1">
                <small className="text-sm text-[#5e6d55] font-medium">
                  Địa chỉ
            ...
            <CardTitle className="flex items-start justify-between">
              ...
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button
                      onClick={() => onOpenModal?.("edit-skill-info")}
                      className="bg-transparent hover:bg-transparent border-2 border-solid border-primary-color rounded-full px-1.5"
                    >
                      <Pencil fill="#108a00" />
                    </Button>
