          ...
          >
            ...
            {userType !== "client" ? (
              <Form.Item
                ...
                name="skill"
                rules={[
                  { required: true, message: "Vui chọn ít nhất 1 kỹ năng!" },
                ]}
              >
                <Select
                  mode="multiple"
            ...
            <Form.Item
                          label="Ảnh đại diện"
                          name="avatar"
              rules={[{ required: true, message: "Vui chọn ảnh đại diện!" }]}
            >
            ...
            >
              <Editor
                ...
                onEditorChange={(content) => form.setFieldsValue({ introduce: content })}
                          />
            </Form.Item>
